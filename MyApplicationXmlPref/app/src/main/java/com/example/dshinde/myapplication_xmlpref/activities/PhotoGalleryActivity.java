...
import com.example.dshinde.myapplication_xmlpref.adapters.RecyclerViewPhotoAdapter;
...
public class PhotoGalleryActivity extends AppCompatActivity {
    ...
    private RecyclerViewPhotoAdapter imageRVAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_photogallary_recyclerview);
    ...
    private void prepareRecyclerView() {
        ...
        imageRVAdapter = new RecyclerViewPhotoAdapter(this, imagePaths);
