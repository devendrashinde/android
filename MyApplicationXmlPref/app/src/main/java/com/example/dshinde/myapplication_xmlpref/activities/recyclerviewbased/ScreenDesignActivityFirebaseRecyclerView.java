...
import com.example.dshinde.myapplication_xmlpref.adapters.FirebaseRecyclerViewKeyValueAdapter;
...
public class ScreenDesignActivityFirebaseRecyclerView extends BaseActivity {
    ...
    EditText searchText;
    FirebaseRecyclerViewKeyValueAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFirebaseInstance();
        loadUI(bundle);
        //initDataStorageAndLoadData(this);
    }

    private void loadFirebaseInstance() {
        mbase = FirebaseDatabase
                    .getInstance()
                    .getReference(Constants.DATABASE_PATH_NOTE_DETAILS + "/" + (isDesignMode() ? Constants.SCREEN_DESIGN_NOTE_PREFIX : "") + collectionName + "/" + userId);
    }
    ...
    private void populateListView() {
        ...
        FirebaseRecyclerOptions<KeyValue> keyvalues
                = new FirebaseRecyclerOptions.Builder<KeyValue>()
                .setQuery(mbase, KeyValue.class)
                .build();

        listAdapter = new FirebaseRecyclerViewKeyValueAdapter(keyvalues, this,
